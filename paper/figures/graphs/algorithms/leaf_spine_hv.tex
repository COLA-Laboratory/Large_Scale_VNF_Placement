...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/algorithm_comparison/LeafSpine/PPLS_Simple/hv.csv};
        % PPLS/D
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/algorithm_comparison/LeafSpine/PPLSD/hv.csv};
        % MOEA/D
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/algorithm_comparison/LeafSpine/MOEAD/hv.csv};
        % IBEA
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/algorithm_comparison/LeafSpine/IBEA/hv.csv};
        % NSGA-II
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/algorithm_comparison/LeafSpine/NSGA-II/hv.csv};
