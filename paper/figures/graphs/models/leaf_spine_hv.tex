...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/0.5/hv.csv};
        % M/M/1/K
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/inf/hv.csv};
        % Utilization
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/UtilisationModel/hv.csv};
        % M/M/1
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/MM1Model/hv.csv};
        % Utilization Latency
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/UtilLatencyModel/hv.csv};
        % Perc - Length
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/PercLenModel/hv.csv};
        % Constant
        ...
        table[x index = 0, y index = 2, col sep = comma, y error minus index = 1, y error plus index = 3]
            {../../../../processed/model/comparison/LeafSpine/ConstantModel/hv.csv};
